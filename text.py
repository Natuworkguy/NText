    ...
    def run(self):
        while True:
            ...
            if command[0] == 'create' and len(command) == 2:
                ...
                os.system('ls')
            elif len(command) > 2 and command[0] == 'dir':
                os.system(f'cd {command[1]}')
            elif command[0] == 'dir':
                print("Command '{command[0]}' takes arguments. Use 'help' for help text")
            elif command[0] == "help":
                self.helptext()
            elif command[0] == 'exit' or command[0] == '_session[exit]':
                break
            else:
                print(f"{command[0]}: TextCube not found")
